	 ...
	 $check_payu_website = DB::table('settings_meta')
	  ...
	  /* new */		 
		...
		/* perfect money */
		 ...
		 $check_perfect_salt = DB::table('settings_meta')
		...
		$check_perfect_name = DB::table('settings_meta')
		...
		$check_local_name = DB::table('settings_meta')
    ...
    protected function editsettings(Request $request)
    {
		...
		if($data['perfectmoney_id']!="")
		{
		   ...
		   $check_user_payment =  DB::table('settings_meta')
			...
			if(!empty($check_user_payment))
			{
			   DB::update('update settings_meta set sett_meta_value="'.$data['perfectmoney_id'].'" where sett_meta_key="perfectmoney_id" and sett_meta_id = ?', [90]);
			}
			else
			{
			DB::insert('insert into settings_meta (sett_meta_id,sett_meta_key,sett_meta_value) values (?, ?, ?)', [90,"perfectmoney_id",$data['perfectmoney_id']]);
		...
		if($data['perfectmoney_name']!="")
		{
		   ...
		   $check_user_payment =  DB::table('settings_meta')
			...
			if(!empty($check_user_payment))
			{
			   DB::update('update settings_meta set sett_meta_value="'.$data['perfectmoney_name'].'" where sett_meta_key="perfectmoney_name" and sett_meta_id = ?', [91]);
			}
			else
			{
			DB::insert('insert into settings_meta (sett_meta_id,sett_meta_key,sett_meta_value) values (?, ?, ?)', [91,"perfectmoney_name",$data['perfectmoney_name']]);
		...
		if($data['bank_details']!="")
		{
		   ...
		   $check_user_payment =  DB::table('settings_meta')
			...
			if(!empty($check_user_payment))
			{
			   DB::update('update settings_meta set sett_meta_value="'.$data['bank_details'].'" where sett_meta_key="bank_details" and sett_meta_id = ?', [98]);
			}
			else
			{
			DB::insert('insert into settings_meta (sett_meta_id,sett_meta_key,sett_meta_value) values (?, ?, ?)', [98,"bank_details",$data['bank_details']]);
