...
class PageController extends Controller
{
     ...
     */
	 ...
	 public function avigher_test()
	 {
	    $url = URL::to("/");
		/*$img = Image::make($url.'/local/images/saravanan.png');
		
		
		
		$img->insert($url.'/local/images/nophoto.jpg');
		
		$img->save(base_path('images/newone.jpg'));*/
	...
	$url = URL::to("/");
	   ...
	   $videofile = Input::file('profile_banner'); 
		 if(isset($videofile))
		 { 
