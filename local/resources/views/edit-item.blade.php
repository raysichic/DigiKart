...
<body>
    ...
    <div class="row">
		   ...
		   <label><?php echo translate( 1218, $lang);?> <span class="required">*</span></label>
            ...
            <textarea placeholder="" class="validate[required] form-control" name="item_short_desc[]" style="width:100% !important; height:100px;"><?php echo html_entity_decode($viewshort); ?></textarea>
		  </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label><?php echo translate( 1182, $lang);?> <span class="required">*</span></label>
                                       ...
                                       <select name="item_script_type" id="item_script_type" class="validate[required]">
                                        ...
                                        <option value="code" <?php if($edit[0]->item_script_type=="code"){?> selected <?php } ?>><?php echo translate( 1185, $lang);?></option>
                                        <option value="graphics" <?php if($edit[0]->item_script_type=="graphics"){?> selected <?php } ?>><?php echo translate( 1188, $lang);?></option>
                                        </select> 
                                    </div>
                                </div>
