...
<?php if(!empty($items_count)){?>
	...
	@endif
        ...
        <?php } ?>
			...
			<img class="thumbnail img-responsive" title="" src="<?php echo $ggimg;?>">
		</div>
        <?php } else {?>
        <div class="item" id="image-1">
			<img class="thumbnail img-responsive" title="" src="<?php echo $url;?>/local/images/media/screenshots/<?php echo $gallery->image;?>">
		</div>
                                            ...
                                            <li>
                                                <div class="single-comment">
                                                    ...
                                                    <?php if(!empty($user_details[0]->photo)){?>
                                                        <img src="<?php echo $url;?>/local/media/userphoto/<?php echo $user_details[0]->photo;?>" alt="">
                                                    <?php } else { ?> 
                       ...
                       {{ csrf_field() }}
                        ...
                        <div class="product-widget">
                           <h3 class="prodect-info-heading"><?php echo translate( 556, $lang);?></h3>
                            ...
                            <div class="col-md-4">
                            <a href="<?php echo $url;?>/user/<?php echo $author_slug;?>"><?php if(!empty($author_photo)){?><img src="<?php echo $url;?>/local/images/media/userphoto/<?php echo $author_photo;?>" class="itemauthor" border="0" alt="<?php echo $author;?>" /><?php } else { ?><img src="<?php echo $url;?>/local/images/nophoto.jpg" class="itemauthor" border="0" alt="<?php echo $author;?>" /><?php } ?></a>
                            </div>
