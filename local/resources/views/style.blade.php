...
.searchhome input[type="button"],.searchhome input[type="submit"]
{
...
.loader {
    ...
    height: 100%;
    z-index: 9999;
    background: url('<?php echo $url;?>/local/images/media/settings/<?php echo $setts[0]->site_loading_url;?>') 50% 50% no-repeat rgb(249,249,249);
    opacity: 1;
